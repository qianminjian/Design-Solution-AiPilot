...
/**
 * 门禁决策实体
 * 对应表 portfolio.gate_decision，见 V2__init_portfolio_requirement.sql §1.3
 *
 * <p>核心不变量：
 * <ul>
 ...
 */
@Entity
@Table(name = "gate_decision", schema = "portfolio")
public class GateDecision extends TenantBaseEntity {
